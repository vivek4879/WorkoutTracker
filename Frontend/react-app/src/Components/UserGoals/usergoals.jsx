...
import "./usergoals.css"; // Optional: style separately
...
const UserGoals = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const selectedTypes = Object.keys(workoutTypes).filter(
    ...
    // You can later send `goalData` to backend or localStorage
        ...
        <div className="set-goals-container">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              <label>Weekly Duration Goal (in minutes):</label>
              <input
                type="number"
                value={durationGoal}
            ...
            <div className="form-group">
              <label>Target Workout Types:</label>
              <div className="checkbox-group">
                <label>
                  <input
                    type="checkbox"
                    name="cardio"
                    checked={workoutTypes.cardio}
                ...
                <label>
                  <input
                    type="checkbox"
                    name="flexibility"
                    checked={workoutTypes.flexibility}
                    onChange={handleCheckboxChange}
                  />
                  Flexibility
                </label>
